namespace IfAndElseNesting
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //nesting tähendab, et if-else struktuuride sees võib olla teisi if-else struktuure. See võimaldab keerukamaid otsuseid ja kontrollida erinevaid tingimusi
