namespace DataTypes
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //andmeüüp toetab ainult true ja false väärtusi
            //myString on muutja, mis on defineeritud andmetüübiga string
            //saab sisestada kõik, mis on klaviatuuril
            string myString = "Hello, World123!";
            //kirjutage cw ja vajutage tab, et genererida Console.WriteLine
            ...
            //kui kaks int tüüpi muutjat liita, siis liidetakse nende väärtused kokku
            ...
            //double o ujukomaarvuline andmetüüp, mis toetab ainult ujukomaarve
            double myDouble = 5.5;
